class BranchesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @branch.save
        format.html { redirect_to branches_url(@branch), notice: "Branch was successfully created." }
  ...
  def update
    respond_to do |format|
      if @branch.update(branch_params)
        format.html { redirect_to branches_url(@branch), notice: "Branch was successfully updated." }
